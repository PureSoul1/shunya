...
export const Audio = ({
  ...
  const { selectedSttProvider, ShunyaApiEnabled, selectedAudioDevices } =
    useApp();
  ...
  return (
    <Popover open={micOpen} onOpenChange={setMicOpen}>
      <PopoverTrigger asChild>
        {(ShunyaApiEnabled || speechProviderStatus) && enableVAD ? (
          <AutoSpeechVAD
      ...
      <PopoverContent
        ...
        side="bottom"
        className={`w-80 p-3 ${
          ShunyaApiEnabled || speechProviderStatus ? "hidden" : ""
        }`}
        sideOffset={8}
      >
