...
import { BotIcon, HeadphonesIcon, Loader2 } from "lucide-react"; // SparklesIcon hata diya
    ...
    <div className="rounded-lg border border-border/50 bg-muted/20 p-3 space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <div className="flex items-center justify-center bg-orange-600 text-white rounded-full h-4 w-4 text-[8px] font-bold">S</div>
